...
class SendCamShareInviteTask : public ITask
{
public:
	SendCamShareInviteTask(void);
	virtual ~SendCamShareInviteTask(void);
...
public:
	// 初始化参数
	bool InitParam(const string& userId, const string& camShareMsg);
