 ...
 * author: Samson.Fan
 *   date: 2015-08-03
 *   file: GetFeeRecentContactListTask.h
...
class GetFeeRecentContactListTask : public ITask
{
public:
	GetFeeRecentContactListTask(void);
	virtual ~GetFeeRecentContactListTask(void);
