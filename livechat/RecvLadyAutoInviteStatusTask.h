 ...
 * author: Alex shum
 *   date: 2016-08-24
 *   file: RecvLadyAutoInviteStatusTask.h
...
class RecvLadyAutoInviteStatusTask : public ITask
{
public:
	RecvLadyAutoInviteStatusTask(void);
	virtual ~RecvLadyAutoInviteStatusTask(void);
