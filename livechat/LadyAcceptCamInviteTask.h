 ...
 * author: Alex.shum
 *   date: 2016-10-27
 *   file: LadyAcceptCamInviteTask.h
...
class LadyAcceptCamInviteTask : public ITask
{
public:
	LadyAcceptCamInviteTask(void);
	virtual ~LadyAcceptCamInviteTask(void);
...
public:
	// 初始化参数
	bool InitParam(const string& userId, const string& camShareMsg, bool isOpenCam);
