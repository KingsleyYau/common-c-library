 ...
 * author: Alex shum
 *   date: 2016-11-28
 *   file: RecvCamHearbeatExceptionTask.h
...
class RecvCamHearbeatExceptionTask : public ITask
{
public:
	RecvCamHearbeatExceptionTask(void);
	virtual ~RecvCamHearbeatExceptionTask(void);
