 ...
 * author: Samson.Fan
 *   date: 2015-03-31
 *   file: UploadPopLadyAutoInviteTask.h
...
class UploadPopLadyAutoInviteTask : public ITask
{
public:
	UploadPopLadyAutoInviteTask(void);
	virtual ~UploadPopLadyAutoInviteTask(void);
